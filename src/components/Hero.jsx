...
export default function Hero(props) {
  ...
  return (
    <section  className='px-10 relative overflow-hidden flex flex-col gap-5 sm:gap-30 items-center justify-center bg-[radial-gradient(circle at 50% , #3F3F47, #18181B)]'>
        ...
        <div className='Current_Stack hero flex flex-col gap-10 items-center justify-center'>
            ...
            <div className='tech_stack hero grid grid-cols-2 sm:grid-cols-3'>
                {tech_stack.map((option, optionIndex)=>{
                  return(
                    <div key={optionIndex} id={optionIndex} className='element hero flex flex-col items-center justify-center' >
