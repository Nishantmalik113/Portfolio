...
export default function WelcomePage() {
  return (
    <div className='flex flex-col items-center justify-center px-10 min-h-screen'>
        ...
        <h1 className='Header my-10'>Hi. I'm Nishant.<br /> A Front-End Developer.</h1>
        <h1 className='flex flex-col w-full text-right'><i className='fa-solid fa-code'></i></h1>
        <p className='mb-10 heading'>Building seamless, interactive web applications with a focus on performance and user experience.</p>
