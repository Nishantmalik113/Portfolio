...
export default function WelcomePage() {
  return (
    <div className='welcome flex flex-col mt-[5vh] items-center justify-center px-10 min-h-screen'>
        <h1 className='flex w-full'><i className='fa-solid fa-code'></i></h1>
        <h1 className='Header my-10'>Hi. I'm Nishant.<br /> A<span className='sm:p-0 pr-2'></span> Front-End Developer.</h1>
